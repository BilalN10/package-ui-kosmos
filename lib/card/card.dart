    ...
    return Material(
        ...
        child: Container(
          constraints: boxConstraints ??
              ...
              BoxConstraints(
                  minHeight: formatHeight(125), minWidth: formatWidth(135), maxHeight: formatHeight(125), maxWidth: formatWidth(135)),
                      ...
                      child: imageWidget ??
                          Container(
                            ...
                            decoration: imageProvider != null
                                ...
                                : BoxDecoration(borderRadius: BorderRadius.circular(formatWidth(7)), color: const Color(0xFF02132B)),
                          ),
                    ),
                    Padding(
                      padding: paddingText ??
                          ...
                          (center
                              ...
                              : EdgeInsets.only(left: formatWidth(14), bottom: formatHeight(9))),
                      child: center
                          ? Center(
                              child: Column(
                                ...
                                children: [
                                  Text(title,
                                      style: titleStyle ??
                                          ...
                                          TextStyle(fontSize: sp(13), fontWeight: FontWeight.w600, color: const Color(0xFF02132B))),
                                  Text(subTitle,
                                      style: subTitleStyle ??
                                          themeData.subTitleStyle ??
                                          TextStyle(fontSize: sp(10), fontWeight: FontWeight.w400, color: const Color(0xFF5A6575))),
                                ],
                              ),
                            )
                          : Column(
    ...
    return Material(
        ...
        child: Container(
          constraints: boxConstraints ??
              ...
              (horizontal
                  ? BoxConstraints(
                      minHeight: formatHeight(125), minWidth: formatWidth(315), maxHeight: formatHeight(125), maxWidth: formatWidth(315))
                  : BoxConstraints(
                      minHeight: formatHeight(176), minWidth: formatWidth(139), maxHeight: formatHeight(176), maxWidth: formatWidth(139))),
          decoration: BoxDecoration(
              color: backgroundColor ?? themeData.backgroundColor ?? Colors.white,
              borderRadius: BorderRadius.circular(radius ?? themeData.radius ?? formatWidth(10))),
          child: Material(
                ...
                child: Stack(
                  children: !horizontal
                      ? [
                          ...
                          Padding(
                            padding:
                                paddingText ?? themeData.paddingText ?? EdgeInsets.only(left: formatWidth(14), bottom: formatHeight(9)),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
  ...
  Widget card(ImageProvider<Object>? image) {
    ...
    return Container(
      constraints: boxConstraints ??
          themeData.constraints ??
          BoxConstraints(
              minHeight: formatHeight(186), minWidth: formatWidth(146), maxHeight: formatHeight(186), maxWidth: formatWidth(146)),
                          ...
                          children: [
                            miniImageWidget ??
                                Container(
                                  ...
                                  decoration: miniImageProvider != null
                                      ? BoxDecoration(
                                          shape: BoxShape.circle, image: DecorationImage(image: miniImageProvider!, fit: BoxFit.cover))
                                      : const BoxDecoration(
                                          shape: BoxShape.circle,
                                          color: Color(0xFF02132B),
                                        ),
                            ...
                            Column(
                              ...
                              children: [
                                Text(title,
                                    style: titleStyle ??
                                        themeData.titleStyle ??
                                        TextStyle(fontSize: sp(12), fontWeight: FontWeight.w600, color: const Color(0xFF02132B)),
                                    textAlign: TextAlign.left),
                                Text(subTitle,
                                    style: subTitleStyle ??
                                        themeData.subTitleStyle ??
    ...
    return Material(
        ...
        child: Container(
          ...
          constraints: boxConstraints ??
              (horizontal
                  ? BoxConstraints(
                      minHeight: formatHeight(96), minWidth: formatWidth(312), maxHeight: formatHeight(96), maxWidth: formatWidth(312))
                  : BoxConstraints(
                      minHeight: formatHeight(156), minWidth: formatWidth(158), maxHeight: formatHeight(156), maxWidth: formatWidth(158))),
          decoration: BoxDecoration(
            color: backgroundColor ?? themeData.backgroundColor ?? Colors.white,
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        style: tagStyle ??
                                            themeData.tagStyle ??
                                            TextStyle(fontSize: sp(7), fontWeight: FontWeight.w500, color: Colors.white),
                                      ),
                                    ),
                                  ),
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: titleStyle ??
                                      themeData.titleStyle ??
                                      TextStyle(fontSize: sp(11), fontWeight: FontWeight.w600, color: const Color(0xFF02132B)),
                                  textAlign: TextAlign.left,
                                  maxLines: 2,
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                width: formatWidth(34),
                                decoration:
                                    BoxDecoration(borderRadius: BorderRadius.circular(formatWidth(5)), color: const Color(0xFF02132B)),
                                child: Center(
                                    child: Text(
                                  'Tag',
                        ...
                        children: [
                          Text(mark,
                              style: markTextStyle ??
                                  ...
                                  TextStyle(fontSize: sp(11), fontWeight: FontWeight.w400, color: const Color(0xFF5A6575))),
                      ...
                      children: [
                        Padding(
                          padding: paddingImage ??
                              ...
                              EdgeInsets.fromLTRB(formatWidth(13), formatHeight(11), formatWidth(16), formatHeight(11)),
                          child: bigImage
                              ? imageWidget ??
                                  Container(
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsets.fromLTRB(formatWidth(0), formatHeight(20), formatWidth(14), formatHeight(26)),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: descStyle ??
                                            themeData.descStyle ??
                                            TextStyle(fontSize: sp(12), fontWeight: FontWeight.w400, color: const Color(0xFF02132B)),
                                        textAlign: TextAlign.left,
                                      ),
                                    ],
                                  ),
        ...
        child: Container(
          constraints: boxConstraints ??
              ...
              BoxConstraints(
                  minHeight: formatHeight(125), minWidth: formatWidth(315), maxHeight: formatHeight(125), maxWidth: formatWidth(315)),
          decoration: BoxDecoration(
            boxShadow: boxShadow ? [BoxShadow(color: Colors.black.withOpacity(0.02), blurRadius: 10, offset: const Offset(0, 10))] : null,
            color: backgroundColor ?? themeData.backgroundColor ?? Colors.white,
            borderRadius: BorderRadius.circular(radius ?? themeData.radius ?? formatWidth(10)),
          ),
          child: Material(
                  ...
                  children: [
                    if (threeDots)
                      Align(
                        alignment: Alignment.topRight,
                        child: Padding(
                          padding: threePointWidgetPadding ??
                              themeData.paddingTriplePoint ??
                              EdgeInsets.only(top: formatHeight(7), right: formatWidth(4)),
                          child: InkWell(
                    ...
                    Padding(
                      padding: contentPadding ??
                          ...
                          EdgeInsets.fromLTRB(formatWidth(17), formatHeight(17), formatWidth(16), formatHeight(19)),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(title,
                            ...
                            children: [
                              ...
                              withStatus
                                  ? Container(
                                      ...
                                      width: formatWidth(99),
                                      decoration: BoxDecoration(
                                          color: statusColor ?? const Color(0xFF02132B).withOpacity(0.03),
                                          borderRadius: BorderRadius.circular(radius ?? themeData.radius ?? formatWidth(10))),
                                      child: Center(
                                        child: Text(
                                          statusText,
...
class _Seven extends StatelessWidget implements Cards {
  ...
  Widget card(ImageProvider<Object>? image) {
    ...
    return Container(
      constraints: boxConstraints ??
          BoxConstraints(
              minHeight: formatHeight(190), minWidth: formatWidth(315), maxHeight: formatHeight(190), maxWidth: formatWidth(315)),
      padding: contentPadding ??
          (!variant ? EdgeInsets.fromLTRB(formatWidth(19), formatHeight(0), formatWidth(7), formatHeight(13)) : EdgeInsets.zero),
      decoration: image != null
          ? BoxDecoration(
              image: DecorationImage(image: image, fit: BoxFit.cover),
              borderRadius: BorderRadius.circular(radius ?? themeData.radius ?? formatWidth(10)))
                ...
                children: !variant
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(title,
                                  style: titleStyle ??
                                      themeData.titleStyle ??
                                      TextStyle(fontSize: sp(14), fontWeight: FontWeight.w600, color: Colors.white),
                                  textAlign: TextAlign.left),
                              Text(subTitle,
                                  style: subTitleStyle ??
                                      themeData.subTitleStyle ??
                                      TextStyle(fontSize: sp(10), fontWeight: FontWeight.w400, color: Colors.white),
                                  textAlign: TextAlign.left),
                            ],
                          ),
                        ),
                    ...
                    : [
                        ...
                        Padding(
                          ...
                          child: Align(
                              alignment: Alignment.bottomRight, child: Text(subTitle, style: subTitleStyle, textAlign: TextAlign.left)),
                        ),
                        Padding(
                ...
                child: Stack(
                  children: [
                    Row(
                      children: [
                        Padding(
                          padding: paddingImage ??
                              themeData.paddingImage ??
                              EdgeInsets.only(left: formatWidth(7), bottom: formatHeight(6), top: formatHeight(6)),
                          child: imageWidget ??
                              Container(
                    ...
                    Align(
                      alignment: Alignment.topRight,
                      child: Padding(
                        padding: doublePointPadding ??
                            themeData.paddingDoublePoint ??
                            EdgeInsets.only(top: formatHeight(7), right: formatWidth(3)),
                        child: InkWell(
                          borderRadius: BorderRadius.circular(radius ?? themeData.radius ?? formatWidth(10)),
                          onTap: doublePointonTap,
                          onDoubleTap: doublePointonDoubleTap,
